...
{
    ChartManager.delegatorObj[delegator.getElementId()] = delegator;
};

ChartManager.removeDelegator = function(delegator)
{
    delete ChartManager.delegatorObj[delegator.getElementId()];
};
...
//        alert(arrJongmokData);
        ...
        if (arrJongmokData != null)
        {
            ...
            var divRow = '<div class="_AView-Style ui-droppable" data-base="_AView" data-class="_AView" style="width: 600px; height: 100px; background-color: rgba(0, 0, 0, 0); left: 0px; top: 0px; position: relative; border-bottom:1px solid #111111;"></div>'
...
//param[1-5] : 날짜, 시가, 고가, 저가, 종가
//------------------------------------------------------
ChartManager.onChartTouchData = function(chartId, strDate, strStart, strHigh, strLow, strClose)
{
