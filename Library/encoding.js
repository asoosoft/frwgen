  ...
  function indexGB18030CodePointFor(pointer) {
    ...
    var /** @type {number} */ offset = 0,
        ...
        /** @type {Array.<Array.<number>>} */ idx = _index_('gb18030');
    var i;
    ...
    this.decode = function(byte_pointer) {
      ...
      if (gbk_first !== 0x00) {
        ...
        code_point = pointer === null ? null :
            indexCodePointFor(pointer, _index_('gbk'));
        if (pointer === null) {
          byte_pointer.offset(-1);
        }
        if (code_point === null) {
  ...
  function GBKEncoder(gb18030, options) {
    ...
    this.encode = function(output_byte_stream, code_point_pointer) {
      ...
      var pointer = indexPointerFor(code_point, _index_('gbk'));
      if (pointer !== null) {
    ...
    this.decode = function(byte_pointer) {
      ...
      if (big5_lead !== 0x00) {
        ...
        var code_point = (pointer === null) ? null :
            indexCodePointFor(pointer, _index_('big5'));
        if (pointer === null) {
          byte_pointer.offset(-1);
        }
        if (code_point === null) {
  ...
  function Big5Encoder(options) {
    ...
    this.encode = function(output_byte_stream, code_point_pointer) {
      ...
      var pointer = indexPointerFor(code_point, _index_('big5'));
      if (pointer === null) {
        return encoderError(code_point);
      }
  ...
  function EUCJPEncoder(options) {
    ...
    this.encode = function(output_byte_stream, code_point_pointer) {
      ...
      var pointer = indexPointerFor(code_point, _index_('jis0208'));
      if (pointer === null) {
        return encoderError(code_point);
      }
        ...
        case state.trail:
          ...
          if (inRange(iso2022jp_lead, 0x21, 0x7E) &&
            ...
            code_point = (iso2022jp_jis0212 === false) ?
                indexCodePointFor(pointer, _index_('jis0208')) :
                indexCodePointFor(pointer, _index_('jis0212'));
          }
          if (code_point === null) {
            return decoderError(fatal);
          }
  ...
  function EUCKRDecoder(options) {
    ...
    this.decode = function(byte_pointer) {
      ...
      if (euckr_lead !== 0x00) {
        ...
        var code_point = (pointer === null) ? null :
            indexCodePointFor(pointer, _index_('euc-kr'));
        if (pointer === null) {
          byte_pointer.offset(-1);
        }
        if (code_point === null) {
  ...
  function EUCKREncoder(options) {
    ...
    this.encode = function(output_byte_stream, code_point_pointer) {
      ...
      var pointer = indexPointerFor(code_point, _index_('euc-kr'));
      if (pointer === null) {
        return encoderError(code_point);
      }
      var lead, trail;
   ...
   * @param {{fatal: boolean}=} options
   */
  function ATextEncoder(opt_encoding, options) 
  {
   ...
   * @param {{fatal: boolean}=} options
   */
  function ATextDecoder(opt_encoding, options) 
  {
    opt_encoding = opt_encoding ? String(opt_encoding) : DEFAULT_ENCODING;
    options = Object(options);
    /** @private */
